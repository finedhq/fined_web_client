        ...
        <div className="bg-gray-100 min-h-screen flex flex-col pb-5">
            ...
            {isAuthenticated ?
              ...
              ${canScrollRight ? 'bg-amber-400 text-white hover:bg-amber-500' : 'bg-white text-amber-300'}`}
                                ...
                                {/* <div ref={carouselRef} className="flex flex-col flex-wrap gap-y-4 gap-x-8.5 h-185 mx-4 px-2 sm:px-0 overflow-x-auto">
                                    {courses.map((course) => (
              ...
              ${canScrollRight ? 'bg-amber-400 text-white hover:bg-amber-500' : 'bg-white text-amber-300'}`}
                    ...
                    {/* <div ref={carouselRef} className="flex flex-col flex-wrap gap-y-4 gap-x-[36px] h-185 mx-4 overflow-x-auto">
                        {courses.map((course) => (
                            <CourseCard key={course.id} course={course} isAuthenticated={isAuthenticated} />
                        ))}
                    </div> */}
