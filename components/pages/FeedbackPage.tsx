...
export default function FeedbackPage() {
	...
	type FormNumberKeys = 'q1_helpfulness' | 'q3_navigation' | 'q7_returnLikelihood';
	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement> | undefined) => {
		...
		const requiredFields: (keyof typeof form)[] = ["name", "email", "q2_difficulty", "q4_design", "q5_confusing", "q6_favFeature"]
	...
	const renderStars = (name: FormNumberKeys, value: number) => (
