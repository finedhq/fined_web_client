...
export function SimpleEditor({ content, onChange }: SimpleEditorProps) {
  ...
  return (
    <div className="relative simple-editor-wrapper w-full border border-gray-300 rounded-md px-3 py-2 text-gray-700 resize-y focus:ring-2 focus:ring-indigo-500">
