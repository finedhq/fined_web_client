                  ...
                  {articles.slice(1).map((article, index) =>
                    <div onClick={() => openArticle(article)} key={index + 4} className="flex gap-4 sm:gap-6 cursor-pointer h-20 w-11/12 sm:h-36 sm:w-157.5">
                      <SmartImage
                        ...
                        fill
                        containerClassName="w-24 h-20 sm:w-40 sm:h-36 rounded-lg"
                        className="w-24 h-20 sm:w-40 sm:h-36 rounded-lg"
                      />
                      <div>
            ...
            {/* <div className="flex flex-col sm:flex-row gap-6 px-4 sm:px-10 py-12 bg-gray-100">
              ...
              <div onClick={() => openArticle(articles[1])} className='cursor-pointer min-w-1/2' >
                <SmartImage
                  ...
                  className="rounded-2xl w-full h-40 sm:h-72 mb-4 sm:mb-6"
                />
              ...
              <div onClick={() => openArticle(articles[2])} className="flex flex-col gap-4 sm:gap-10 min-w-1/2 cursor-pointer">
                ...
                <div className='sm:mr-6' >
                  <SmartImage
                    ...
                    alt="article_image_3"
                    fill
                    className="rounded-2xl w-full h-40 sm:h-72"
                  />
                </div>
              </div>
            </div> */}
                ...
                {articles.slice(3).map((article, index) =>
                  <div key={index + 4} onClick={() => openArticle(article)} className="flex gap-5 mb-6 p-4 cursor-pointer">
                    <SmartImage
                      ...
                      alt={`article_image_${index + 4}`}
                      fill
                      className="w-33 h-32 rounded-md"
                    />
                    <div>
          ...
          <div className="flex flex-col sm:flex-row px-4 sm:px-10 py-5 sm:py-10 gap-6">
            ...
            <div className="flex flex-col gap-6 min-w-1/2">
              ...
              <div ref={carouselRef1} style={{ scrollbarWidth: 'none', overflowX: 'auto', columnGap: '0rem' }} className="h-72 sm:h-125 sm:w-full columns-1 carousel-track-1 space-y-5.5 gap-2" >
                {articles.slice(1).map((article, index) =>
                  <div onClick={() => openArticle(article)} key={index + 4} className="relative flex gap-4 sm:gap-6 cursor-pointer h-20 w-11/12 sm:h-36 sm:w-157.5">
                    <SmartImage
                      src={article?.image_url}
                      alt={`article_image_${index + 4}`}
                      fill
        ...
        ${(selectedIndex < articles.length - 1 || hasMore)
          ...
          <div className="bg-white w-full h-full overflow-y-auto p-6 sm:p-10 relative rounded-none shadow-lg transition-all duration-300">
            ...
            <SmartImage
              ...
              alt="Article"
              fill
              containerClassName='h-60 w-full sm:h-3/4 sm:max-h-full rounded-md mb-6'
              className="h-60 w-full sm:h-3/4 sm:max-h-full rounded-md mb-6"
            />
